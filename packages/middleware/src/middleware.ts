...
export async function verifyAuth(
  request: Request,
  config: Pick<PocketBaseAuthConfig, "pocketbaseUrl" | "groupField" | "cookieName">
): Promise<AuthResult> {
 ...
 */
export async function handleCookieEndpoint(
  request: Request,
 ...
 */
export function handleLogoutEndpoint(
  _request: Request,
 ...
 * ```
 */
export function createAuthMiddleware(config: PocketBaseAuthConfig) {
  const {
    pocketbaseUrl,
    groupField,
    cookieName = "pb_auth",
