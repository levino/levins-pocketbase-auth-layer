...
export interface PocketBaseAuthConfig {
     ...
     */
    onNotAuthorized?: (request: Request, user: AuthRecord) => Response | Promise<Response>;
    /**
     ...
     */
    onAuthenticated?: (request: Request, user: AuthRecord, groups: RecordModel[]) => Response | Promise<Response>;
}
/**
